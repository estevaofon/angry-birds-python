...
def sling_action():
    ...
    if mouse_distance > rope_lenght:
        ...
        pu = (uv1 * bigger_rope + sling_x, uv2 * bigger_rope + sling_y)
    else:
        mouse_distance += 10
...
def post_solve_bird_pig(arbiter, space, *args, **kwargs):
...
def post_solve_bird_wood(arbiter, space, *args, **kwargs):
...
def post_solve_pig_wood(arbiter, space, *args, **kwargs):
